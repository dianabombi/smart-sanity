...
const Brands = () => {
  const brands = [
    ...
    },
    {
      ...
      logo: '/brands/kaldewei-logo.png',
      category: 'Vane a sprchy',
      darkBackground: false
    },
    {
      name: 'Laufen',
      description: 'Švajčiarsky prémiový výrobca kúpeľňových produktov',
      website: 'https://www.laufen.cz/',
      logo: '/logo_laufen_standard.png',
      category: 'Kúpeľňové vybavenie',
      darkBackground: false
    },
    {
      name: 'Hansgrohe',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            {brands.map((brand, index) => (
              ...
              >
                ...
                {/* Logo Container */}
                <div className={`${brand.darkBackground ? 'bg-gray-800' : 'bg-white'} rounded-lg p-4 mb-4 h-24 flex items-center justify-center`}>
                  <img 
                    src={brand.logo} 
                    alt={`${brand.name} Logo`}
