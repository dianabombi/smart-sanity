...
const WhoWeAre = () => {
  const content = (
    <div className="w-full max-w-7xl mx-auto px-4">
      <div className="flex flex-col items-center justify-center space-y-6">
        ...
        <div className="text-white space-y-4 text-xl tablet:text-2xl leading-relaxed text-center w-full laptop:w-3/5 mx-auto">
          <p>
  ...
  return (
    <Layout>
      ...
      <div className="bg-black flex items-center justify-center py-16 min-h-[60vh]">
        {content}
      </div>
    </Layout>
  );
