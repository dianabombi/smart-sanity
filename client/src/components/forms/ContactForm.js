    ...
    <div className={className}>
      ...
      <form onSubmit={handleSubmit} className="space-y-2 pt-1">
        ...
        <button
          ...
          className="w-full !mt-2 text-gray-300 border border-gray-400 bg-transparent hover:text-white hover:border-white px-8 py-2 rounded-lg font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
        >
