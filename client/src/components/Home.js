  ...
  return (
    <Layout showFooter={false}>
      ...
      <div className="min-h-screen w-full bg-black flex flex-col laptop:flex-row">
        ...
        <div className="relative w-full laptop:w-2/3 h-[40vh] tablet:h-[50vh] laptop:h-screen mb-8 tablet:mb-0 laptop:mb-0">
          <Carousel
        ...
        <div className="w-full laptop:w-1/3 bg-black flex flex-col items-center justify-start tablet:justify-between laptop:justify-between gap-20 tablet:gap-6 laptop:gap-8 px-4 tablet:px-6 py-2 tablet:py-12 laptop:py-0 laptop:items-stretch min-h-[60vh] tablet:min-h-[50vh] laptop:h-screen flex-1 laptop:flex-none">
          {/* Smart Sanit Logo - positioned higher */}
          <div className="flex-shrink-0 pt-2 tablet:pt-6 laptop:pt-16 flex justify-center">
            <img 
              src="/logo.png" 
              alt="Smart Sanit" 
