    ...
    <footer className="bg-black border-t border-gray-700 py-8 px-4 sm:px-6 lg:px-8 shadow-[0_-10px_30px_rgba(89,89,89,0.3)]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="hidden md:block relative">
          ...
          <div className="absolute bottom-0 left-4 flex space-x-4">
            <a 
              href="https://www.instagram.com/smart_sanit_premium_bathrooms?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" 
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="text-center space-y-2">
            ...
            <button 
              onClick={() => navigate('/privacy-policy')}
              className="text-sm text-gray-400 hover:text-gray-300 transition-colors duration-200 underline block mx-auto mt-2"
            >
              Ochrana osobných údajov
            </button>
          </div>
